...
$stmt = $pdo->prepare('SELECT * FROM item natural join item_category where category = "T-shirt" ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM item natural join item_category where category = "T-shirt"')->rowCount();
?>

<?=template_header('T-shirt')?>
    <div class ="category">
...
<div class="products content-wrapper">
    ...
    <div class="products-wrapper">
        ...
        <a href="index.php?page=T-shirt&id=<?=$product['item_id']?>" class="product">
    ...
    <div class="buttons">
        ...
        <a href="index.php?page=T-shirt&p=<?=$current_page-1?>">Prev</a>
        <?php endif; ?>
        <?php if ($total_products > ($current_page * $num_products_on_each_page) - $num_products_on_each_page + count($products)): ?>
        <a href="index.php?page=T-shirt&p=<?=$current_page+1?>">Next</a>
        <?php endif; ?>
    </div>
</div>
